 ...
 * - Upstream commit: 88226f30610d6038a431796a8ae5917199d49c74
 *
...
export function createOfficialCopilotLoader(
  ...
  return async function loader(
    ...
    return {
      ...
      async fetch(request: RequestInfo | URL, init?: RequestInit) {
        const info = await getAuth()
        if (info.type !== "oauth") return fetchImpl(request, init)
...
export function createOfficialCopilotChatHeaders(
